...
import { Menu, X, GraduationCap, User, LogOut, Shield, LayoutDashboard } from 'lucide-react';
              ...
              <>
                ...
                {user?.role === 'admin' ? (
                  <Button
                    variant="outline"
                    size="sm"
                    className="border-[#2B71F8]/50 text-[#5B9AFF] hover:bg-[#2B71F8]/10"
                    asChild
                  >
                    <Link to="/admin">
          ...
          {isAuthenticated ? (
            <div className="mt-4 pt-4 border-t border-white/10">
              ...
              {user?.role === 'admin' ? (
                <Link
                  to="/admin"
                  className="flex items-center gap-2 px-4 py-3 text-[#5B9AFF] hover:bg-[#2B71F8]/10 rounded-lg transition-colors"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                ...
                <Link
                  to="/dashboard"
                  className="flex items-center gap-2 px-4 py-3 text-white/80 hover:bg-white/5 rounded-lg transition-colors"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
